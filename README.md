...
Кросс-платформенный десктоп для **macOS** и **Windows**. Использует ту же кодовую базу что и web-фронтенд, ходит на тот же VPS-бэкенд через HTTPS (`https://194-62-42-159.nip.io`).
